...
class S2GN():
    def __init__(self, path, seed=777, batch_size=512, lr=0.001, weight_decay=0.001, nhid=128, sample_neighbor=True,
                 sparse_attention=True,
                 structure_learning=False, pooling_ratio=0.5, dropout_ratio=0.0, lamb=1.0, device='cpu', epochs=300,
                 patience=100):
        self.path = path
